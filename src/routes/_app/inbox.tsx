...
const SCOPES: {
    id: 'inbox' | 'unread' | 'starred' | 'sent' | 'archived'
    label: string
}[] = [
...
function InboxPage() {
    ...
    const { data: conversations, isPending } = useQuery(
        conversationsQueryOptions(scope)
    )
            ...
            <section className='overflow-auto overscroll-contain'>
                {isPending ? (
                    <SkeletonList
                        ...
                        wrapperClassName='space-y-2 p-3'
                    />
                    ...
                    <Empty className='h-full border-none'>
                        <EmptyHeader>
                            ...
                            <EmptyDescription>
                                Messages in this mailbox will show up here.
                            </EmptyDescription>
                        </EmptyHeader>
                    </Empty>
                ) : (
                    ...
                    <div className='mx-auto max-w-3xl space-y-4'>
                        ...
                        <div className='space-y-3'>
                            {detail.messages.map(m => {
                                const author = detail.participants.find(
                                    p => p.id === m.author_id
                                )
                                return (
                                    <div
