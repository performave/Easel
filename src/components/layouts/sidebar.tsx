...
const SidebarInset = ({
    ...
    return (
        <main
            ...
            className={cn(
                'bg-background relative flex min-w-0 flex-1 flex-col overflow-hidden md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2',
                className
            )}
            {...props}
        />
...
const SidebarHeader = ({
    ...
    return (
        <div
            ...
            data-sidebar='header'
            className={cn(
                'bg-sidebar sticky top-0 z-10 flex flex-col gap-2 p-2',
                className
            )}
            {...props}
        />
